...
import { renderHome } from './pages/wine-home.js';
import { renderTest } from './pages/wine-test.js';
import { renderResult } from './pages/wine-result.js';
import { renderTypes } from './pages/wine-types.js';
import { renderAbout } from './pages/wine-about.js';
import { renderAdmin } from './pages/wine-admin.js';
...
const routes = [
  ...
  { pattern: /^\/wine-admin$/, handler: renderAdmin },
];
